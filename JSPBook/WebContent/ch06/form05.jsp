            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						<!-- 내용을 입력해주세요 -->
						<form action="form05_process.jsp" method="post" name="member">
							...
							<!-- 
								...
								wrap 속성의 값을 soft,hard 로 설정 시, textarea 설정 크기에서
								Enter를 치지 않고 텍스트를 입력해 나갈때, textarea 가로 길이
								오른쪽 맨 끝에 다다를때 자동으로 아래줄로 넘어가 작성이 되는데
								이 때 Enter를 직접 치지는 않았지만 아래줄로 내려가 작성된다.
								
								이 때, hard는 개행문자가 포함된 데이터가 전송된다.
								(개행문자인 '\n\r'이 데이터상에 보여지지는 않지만, 데이터를 
								확인해보면 Enter가 쳐진 상태의 데이터를 확인할 수 있다.)
							 -->
							<textarea rows="10" cols="50" name="comment" placeholder="가입 인사를 입력해주세요!" wrap="hard"></textarea>
							<input class="btn btn-success" type="submit" value="전송"/>
							<input class="btn btn-primary" type="reset" value="리셋"/><br/>
						</form>
                    </div>
                </div>
            </div>
