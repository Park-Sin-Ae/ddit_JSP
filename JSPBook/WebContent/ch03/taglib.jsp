						...
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h5>변수 k가 1부터 10까지 1씩 증가하도록 JSTL의 Core 태그 반복문을 작성</h5>
									</div>
									<div class="card-body">
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h5>
											변수 i가 1부터 10까지 1씩 증가하도록 JSTL의 Core 태그 반복문을 작성 <br>
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h5>
											스크립틀릿과 표현문/JSTL을 통해 Collection 출력 <br>
											<font color="red">JSTL의 Core태그 forEach를 통해 Collection을 출력</font>
										</h5>
