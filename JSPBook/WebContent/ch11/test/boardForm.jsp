						 ...
						 <form action="boardInsert.jsp" method="post" enctype="multipart/form-data">
						 	<table class="table table-bordered">
						 		...
						 		<tr>
						 			<th>파일</th>
						 			<td>
						 				<input type="file" name="fileVO" class="form-control" id="fileSize">
						 		...
						 		<tr>
						 			<td>
						 				...
						 				<a href="boardList.jsp" class="btn btn-info">목록</a>
						 			</td>
						 		</tr>
						 	</table>
						 </form>
