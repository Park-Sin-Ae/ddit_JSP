                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>웹 브라우저의 HTTP 요청 메소드(GET,POST)를 가져온다.</td>
							</tr>
							<tr>
								<th>요청 URL</th>
							...
							<tr>
								...
								<td>현재 JSP페이지의 웹 애프리케이션 컨텍스트 경로를 가져옵니다.</td>
							</tr>
							<tr>
								<th>서버 이름</th>
							...
							<tr>
								...
								<td>웹 브라우저의 전체 요청 파라미터 문자열 <br/>
									[물음표 다음 URL에 할당된]을 가져옵니다.</td>
							</tr>
						</table>
                    </div>
                </div>
