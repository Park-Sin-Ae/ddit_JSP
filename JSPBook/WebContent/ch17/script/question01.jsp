							...
							<div class="card">
								<div class="card-body">
									<div class="form-check form-check-inline">
										...
										<label class="form-check-label" id="chk">append 여부</label>
									</div>
										<h6>선택한 td안에 있는 글자를 아래 P태그에 출력해주세요!</h6>
									<p class="text-info">출력란</p>
									<input type='text' id="modifyInput" style="width : 100%" />
...
modifyBtn.click(function() {
	if($(this).text() == "수정") {
		modifyInput.val(selectedTd.text());
		modifyInput.show();
		$(".text-info").hide();
		$(this).text("확인");
	} else {
		$(this).text("수정");
		$(".text-info").show();
		$(".text-info").text(modifyInput.val());
		selectedTd.text(modifyInput.val());
		modifyInput.val("");
		modifyInput.hide();
	}
})
