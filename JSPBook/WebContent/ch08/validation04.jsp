            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						<!-- 내용을 입력해주세요 -->
						<form action="validation04_process.jsp" method="post" name="member">
...
// flag를 설정하지 않으면 global로서 한번 검색된다.
function checkMember() {
	// 아이디는 영문 대문자와 소문자, 한글, 한글의 자음과 모암만 검사하도록 정규 표현식 작성
	...
	// - 처음 시작이 숫자, 영소대문자이고 특수문자 '-_/.'이 나올수도 있고 안나올수도 있고 그 다음에 숫자, 영소대문자가
	// 0개 이상이 나온다. '@'를 기준으로 앞 입력 형식과 같고 '\.'는 특수문자 .을 표현하기 위해 이스케이프이다.
	// .이 반드시 나와야하고 영소대문자 2~3자리가 끝에 나온다.
	var regExpEmail
	...
	// test() : 매개변수 값으로 전달되는 문자열이 정규 표현식에 부합한지 판단하여 true/false 를 반환
	...
	if(!regExpPhone.test(phone)){
		alert("연락처 형식에 맞게 입력해주세요!(ex 010-1234-1234/ 010-123-1234)");
		return false;
	}
